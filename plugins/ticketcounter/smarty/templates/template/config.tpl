...
<body>{literal}
    <link rel="stylesheet" type="text/css" href="{/literal}{$httpPath|cat:"plugins/ticketcounter/css/config.css"}{literal}" media="all"/>
</head>{/literal}

<div id="info">
    <table class='tab_cadre_fixe'>
        <tr>
            <th>Configuration du plugin Ticketcounter</th>
        </tr>
        <tr>
...
<script type="text/javascript">  
    ...
    function change(action,id_statut,value)
        ...
        xmlhttp.onreadystatechange=function()
          ...
          if (xmlhttp.readyState==4 && xmlhttp.status==200)
              ...
              document.getElementById("configTicketcounter").innerHTML=xmlhttp.responseText;
              }
          }
        xmlhttp.open("POST","{/literal}{$httpPath|cat:"plugins/ticketcounter/ajax/config.ajax.php"}{literal}",true);
    ...
    function ajout()
        ...
        var form = "<table class='tab_cadre'> \n\
            ...
            document.getElementById("configTicketcounter").innerHTML=form ;
        }
